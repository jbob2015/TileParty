...
public class TPArray extends TPBase {

	public static final byte CONTAINER_TYPE = StorageType.ARRAY;
	public byte type;
	public int count;
	public byte[] data;
	...
	public static TPArray Byte(String name, byte[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Short(String name, short[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Char(String name, char[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Integer(String name, int[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Long(String name, long[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Float(String name, float[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Double(String name, double[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Boolean(String name, boolean[] data) {
		TPArray array = new TPArray();
		array.setName(name);
	...
	public static TPArray Deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		TPArray result = new TPArray();
